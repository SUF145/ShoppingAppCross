...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ShoppingAppCross.Android.dll" comes first in this list. */
		"ShoppingAppCross.Android.dll",
		"FormsViewGroup.dll",
		...
		"ShoppingAppCross.Core.dll",
		"ShoppingAppCross.UI.dll",
